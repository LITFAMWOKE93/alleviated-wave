...
var fovy = 45.0; // FOV in y anle degrees
var aspect; // ratio to be stored
...
// sliders for viewing parameters
    ...
    document.getElementById("fovSlider").onchange = function(event) {
        ...
        // Listen for checkbox for perpesctive matrix change
...
var renderPerspective = function() {
    ...
    modelViewMatrix = lookAt(eye, at , up);
    // We use a different function for persective projection here 
